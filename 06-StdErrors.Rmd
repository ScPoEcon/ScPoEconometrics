...
* what is it
* why is it needed
* how does it influence regression
...
```
<br>
We have already seen plots like \@ref(fig:confint) below. We have called the shaded area around the regression line as the *confidence interval* or *confidence band*. Now it's time to define properly what this shaded area tells us.
...
Before delving into further details about this confidence band, we have to make quick detour to statistical sampling and hypothesis tests. We will first give the classical theory, so you know where to look up the formula and how to compute the objects yourself, if needed. Then, we will do a simulation study and make sure all of this is easy to understand. Ready? Go!
