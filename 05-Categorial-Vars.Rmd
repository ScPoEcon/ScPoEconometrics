...
Going back to our wage example, let's say that a workers wage depends on their education as well as their sex:

\begin{equation}
\ln w_i = b_0 + b_1 educ_i + b_2 sex_i + e_i (\#eq:wage-sex)
\end{equation}
...
stargazer::stargazer(lm_w,lm_w_sex,type = "html")
```
