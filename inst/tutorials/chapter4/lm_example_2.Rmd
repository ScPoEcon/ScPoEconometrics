...
Note: the reason we use the `I()` operator around `X^2` is so that it is not confused with another possible use of `^` in the contect of a formula, as we will see later.
