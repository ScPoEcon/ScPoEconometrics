...
```{r}
## read the data from Fivethirtyeight and reshape it  
...
# 
# write.table(data,
#            file = "~/Documents/TA_Econometrics/Repo_github/ScPoEconometrics/inst/datasets/airline-safety.csv",
#            row.names = F,
#            sep = ",")
```

To load the dataset, you can run the following command (NB : it uses the `readr` package)
```{r include=TRUE, cache.comments=FALSE}
# load data from our github repo
data=read_csv("https://raw.github.com/pvilledieu/ScPoEconometrics/airline_safety/inst/datasets/airline-safety.csv")
```
