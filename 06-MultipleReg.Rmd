...
We ask this kind of question all the time in econometrics. In figure \@(fig:plane3Dreg) you clearly see that both explanatory variables have a negative impact on the outcome of interest, but it's kind of hard to read off *how negative* each variable in isolation. Mutiple regression to the rescue!
