...
\KeywordTok{subset}\NormalTok{(d, kfr_pooled_p25 }\ControlFlowTok{if}\NormalTok{ state }\OperatorTok{==}\StringTok{ }\DecValTok{34} \OperatorTok{&}\StringTok{ }\NormalTok{county }\OperatorTok{==}\StringTok{ }\DecValTok{013} \OperatorTok{&}\StringTok{ }\NormalTok{tract }\OperatorTok{==}\StringTok{ }\DecValTok{021000}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\item
