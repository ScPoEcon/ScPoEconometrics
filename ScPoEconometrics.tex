...
b_0  + b_2 \text{exper}_i + e_i & \text{if is.female=0}
\end{cases}
\end{equation}
...
{\centering \includegraphics{ScPoEconometrics_files/figure-latex/unnamed-chunk-158-1} 

}

\caption{Distribution of `lotsize` by `bathrms`}\label{fig:unnamed-chunk-158}
\end{figure}
...
\item
  \href{slides/chapter4/chapter5.html}{chapter 5}
\end{itemize}
