...
\includegraphics{ScPoEconometrics_files/figure-latex/unnamed-chunk-117-1.pdf}
...
\begin{center}\includegraphics{ScPoEconometrics_files/figure-latex/unnamed-chunk-120-1} \end{center}
...
of the example at the end of chapter \ref{lin-reg}. There we introduced
the term \emph{confidence interval}, shown here as the shaded area:

\begin{center}\includegraphics{ScPoEconometrics_files/figure-latex/unnamed-chunk-126-1} \end{center}
...
{\centering \includegraphics{ScPoEconometrics_files/figure-latex/unnamed-chunk-132-1} 

}

\caption{Distribution of `lotsize` by `bathrms`}\label{fig:unnamed-chunk-132}
\end{figure}
