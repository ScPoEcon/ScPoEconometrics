...
\begin{verbatim}
##  [1] -1.956190  3.485536  3.106312 11.036737  6.432686 -3.624753  6.499923
##  [8]  3.871226 10.551008  6.735400
\end{verbatim}
...
\begin{verbatim}
##  [1] -1.3833424 -0.2375593 -0.3174068  1.3523846  0.3829781 -1.7346669
##  [7]  0.3971353 -0.1563503  1.2501118  0.4467161
\end{verbatim}
...
\subsection{\texorpdfstring{\texttt{dplyr\ +\ ggplot} : The
\texttt{tidyverse}}{dplyr + ggplot : The tidyverse}}\label{dplyr-ggplot-the-tidyverse}
...
\subsection{\texorpdfstring{Importing Excel Data (either in
\texttt{.xlsx} or .\texttt{xls}
formats)}{Importing Excel Data (either in .xlsx or .xls formats)}}\label{importing-excel-data-either-in-.xlsx-or-.xls-formats}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tot_pop}\OperatorTok{$}\NormalTok{counts =}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(tot_pop}\OperatorTok{$}\NormalTok{counts)}
\end{Highlighting}
\end{Shaded}
...
Now you can see that column \texttt{counts} is indeed a \texttt{dbl},
i.e.~a number with double precision, and we are fine.
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(Country }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"France"}\NormalTok{,}\StringTok{"United Kingdom"}\NormalTok{,}\StringTok{"Italy"}\NormalTok{,}\StringTok{"Germany"}\NormalTok{)) }\OperatorTok{%>%}
