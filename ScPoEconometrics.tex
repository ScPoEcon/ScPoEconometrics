...
A quick note on styling choices in this book. We had to make a decide
how to visually separate \texttt{R} code and resutling output in this
book. We decided prefix all output lines with
\texttt{\#OUT\textgreater{}} to make the distinction. Notice that you
can simply copy and paste the code into your \texttt{R} console.

\subsection{\texorpdfstring{\texttt{ScPoEconometrics}
...
\begin{verbatim}
#OUT>  [1]   9.1408522  -3.0961893   0.9150544 -11.4084768  -3.2864593
#OUT>  [6]  -3.9139924  -0.9554791   5.2968748   3.2040833  10.7166067
\end{verbatim}
...
\begin{verbatim}
#OUT>  [1]  1.2719967 -0.5636490  0.0380669 -1.8105529 -0.5921909 -0.6863254
#OUT>  [7] -0.2425268  0.6953720  0.3814380  1.5083714
\end{verbatim}
