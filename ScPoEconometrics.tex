...
\tightlist
\item
  The average of \(\hat{y_i}\) to be the same as the mean of \(y\)
\item
...
\begin{center}\includegraphics{ScPoEconometrics_files/figure-latex/unnamed-chunk-139-1} \end{center}
...
{\centering \includegraphics{ScPoEconometrics_files/figure-latex/unnamed-chunk-145-1} 

}

\caption{Distribution of `lotsize` by `bathrms`}\label{fig:unnamed-chunk-145}
\end{figure}
