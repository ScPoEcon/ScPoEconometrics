...
\NormalTok{stargazer}\OperatorTok{::}\KeywordTok{stargazer}\NormalTok{(educ_only, educ_exper, log_wages,}\DataTypeTok{type =} \StringTok{"html"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{stargazer}\OperatorTok{::}\KeywordTok{stargazer}\NormalTok{(lm_w,lm_w_sex,}\DataTypeTok{type =} \StringTok{"html"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{ScPoEconometrics_files/figure-latex/unnamed-chunk-175-1} 

}

\caption{Distribution of `lotsize` by `bathrms`}\label{fig:unnamed-chunk-175}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{```\{r your-chunk-label,echo = FALSE, out.width = "75%"\}}
\FunctionTok{# your-chunk-label: name you give that code chunk (optional)}
\FunctionTok{# echo = TRUE/FALSE: display the code in output?}
\FunctionTok{# out.width = "75%": scale image to 75% of page width}
\FunctionTok{# all options: https://yihui.name/knitr/options/}
\NormalTok{knitr::include_graphics("path_to_your_grahpic.png") }
\NormalTok{```}
\end{Highlighting}
\end{Shaded}
  \item
