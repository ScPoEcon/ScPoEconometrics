...
knitr::opts_chunk$set(comment=ScPoEconometrics:::getprompt())
```
...
This material is used in the Economtrics course of the Campuses of SciencesPo in Paris, Reims, LeHavre, Menton and Dijon. The teaching and development team can be found [here on github](https://github.com/orgs/ScPoEcon/teams/ugmetrics)

### Communication {-}

We will communicate exclusively on our [`slack`](https://econometrics-scpo.slack.com) app. You will get an invitation email to join from your instructor in due course.
